        ...
        <div className="min-h-screen bg-gray-50 flex flex-col">
            ...
            <main className="flex-1">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                    {/* Filters Row */}
                    <div className="bg-white rounded-xl shadow p-4 mb-8 flex flex-wrap items-center gap-6">
                        {/* Status Filter */}
                        <div className="flex items-center gap-3">
                            ...
                            <select
                                ...
                                className="border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-purple-500 focus:border-transparent outline-none bg-gray-50 capitalize transition-all"
                            >
                        ...
                        {/* Price Filter Box */}
                        <div className="flex items-center gap-2 bg-gray-50 border border-gray-300 rounded-lg px-4 py-2 focus-within:ring-2 focus-within:ring-purple-500 focus-within:border-transparent transition-all">
                            ...
                            <div className="flex items-center gap-2">
                                <input
                                    ...
                                    placeholder="Min"
                                    className="w-20 text-sm bg-transparent outline-none border-b border-gray-300 focus:border-purple-500 transition-colors"
                                />
                        ...
                        <div className="flex-1 min-w-[250px] relative">
                            ...
                            <input
                                ...
                                className="w-full border border-gray-300 rounded-lg pl-10 pr-4 py-2 text-sm focus:ring-2 focus:ring-purple-500 focus:border-transparent outline-none bg-gray-50 transition-all"
                            />
                        </div>
                    </div>
                        ...
                        {loading ? (
                                ...
                                <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
                                    {filteredEvents.map((ev) => (
                                        <div key={ev._id} className="bg-white rounded-xl shadow overflow-hidden flex flex-col">
                                            ...
                                            <div className="p-6 flex-1 flex flex-col">
                                                ...
                                                <div className="mt-4 grid grid-cols-2 gap-3 text-sm">
                                                    <div>
                                                        ...
                                                        <p className="font-semibold text-gray-900">{ev.isPaid ? `₹${Number(ev.price ?? 0).toFixed(2)}` : "Free"}</p>
                                                    </div>
                                                    <div>
                                                        <p className="text-xs text-gray-500">Status</p>
                                                        <span className={`inline-block px-2 py-0.5 text-xs font-semibold rounded-full capitalize ${getStatusBadgeColor(ev.effectiveStatus || ev.status)}`}>
                                                ...
                                                <div className="mt-5 grid grid-cols-3 gap-2">
                                                    <button
                                                        ...
                                                        className="px-3 py-2 rounded-lg bg-blue-50 text-blue-600 font-semibold hover:bg-blue-100"
                                                    >
                                                        Edit
                                                    </button>
                                                    <button
                                                    ...
                                                    <a
                                                        ...
                                                        className="px-3 py-2 text-center rounded-lg bg-gray-900 text-white font-semibold hover:bg-black"
                                                    >
                                                        View More
                                                    </a>
                                                </div>
